/* project2_newmapping.c */

#include <stddef.h>

#include "NewSmuTypes.h"
#include "SmuMapping.h"
#include "project2_newtype.h"
#include "project2_newmapping.h"
...
static const MappingEntry scope_2_entries[5] = {
  ...
  /* 2 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L2_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 3 */ { MAP_LOCAL, "_L3@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L3_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 4 */ { MAP_LOCAL, "_L4", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L4_1, &_Type_kcg_bool_Utils, NULL, NULL, NULL}
};
...
static const MappingEntry scope_1_entries[18] = {
  ...
  /* 5 */ { MAP_INPUT, "SignalFromTeam1", NULL, sizeof(kcg_bool), (int)&inputs_ctx.SignalFromTeam1, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 6 */ { MAP_OUTPUT, "SignalToLED", NULL, sizeof(kcg_int), (int)&outputs_ctx.SignalToLED, &_Type_kcg_int_Utils, NULL, NULL, NULL},
  /* 7 */ { MAP_OUTPUT, "SignalToTeam1", NULL, sizeof(kcg_bool), (int)&outputs_ctx.SignalToTeam1, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 8 */ { MAP_EXPANDED, "Toggle 1", NULL, 0, 0, NULL, NULL, NULL, &scope_2},
  /* 9 */ { MAP_LOCAL, "_L1@mem", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L1, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
  /* 10 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), (int)&outputs_ctx._L2, &_Type_kcg_bool_Utils, NULL, NULL, NULL},
...
static const MappingEntry scope_0_entries[1] = {
  /* 0 */ { MAP_ROOT, "project2", NULL, 0, 0, NULL, NULL, NULL, &scope_1}
};
