...
void _SCSIM_Mapping_Create() {
	_SCSIM_Mapping_project1();
	pSimulator->m_pfnFinalizeMapping(pSimulator);
}

/****************************************************************
 ** project1/ mapping function
 ****************************************************************/
void _SCSIM_Mapping_project1() {
	pSimulator->m_pfnSetRoot(pSimulator, "project1/", &outputs_ctx, _SCSIM_Get_project1_Handle);
	pSimulator->m_pfnAddLocal(pSimulator, "_L2", &_SCSIM_kcg_bool_Utils, 1, valid, 0, 0);
	/*<< Inlined Toggle*/
	...
	pSimulator->m_pfnAddLocal(pSimulator, "_L3", &_SCSIM_kcg_bool_Utils, 6, valid, 0, 0);
	pSimulator->m_pfnAddLocal(pSimulator, "_L5", &_SCSIM_kcg_bool_Utils, 7, valid, 0, 0);
	pSimulator->m_pfnPopInstance(pSimulator);
	/*>>*/
	pSimulator->m_pfnAddLocal(pSimulator, "_L1", &_SCSIM_kcg_bool_Utils, 8, valid, 0, 0);
	...
	pSimulator->m_pfnAddOutput(pSimulator, "SignalToTeam2", &_SCSIM_kcg_bool_Utils, 18, valid, 0, 0);
	...
	pSimulator->m_pfnAddInput(pSimulator, "SignalFromButton", &_SCSIM_kcg_bool_Utils, 21, valid, 0, 0);
	pSimulator->m_pfnAddInput(pSimulator, "SignalFromTeam2", &_SCSIM_kcg_bool_Utils, 22, valid, 0, 0);
}

void* _SCSIM_Get_project1_Handle(void* pInstance, int nHandleIdent, int* pIteratorFilter, int nSize) {
	switch (nHandleIdent) {
		case 1:
		...
		case 18:
			return &(outputs_ctx.SignalToTeam2);
		case 19:
		...
		case 22:
			return &(inputs_ctx.SignalFromTeam2);
		default:
			break;
	}
	return 0;
