...
/**
** File C:/Users/Lu/Documents/ITA/CE-237-Teste_Avancado_de_SW/Git_rep/scade-integration-example-1/Team 1/UserApplication/project1/Simulation\project1_UA_1.c
**
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_project1* scade_ctx, 
 ...
 int project1_UA_1_send(buffer_el msg[],  outC_project1* scade_ctx, 
  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
int project1_UA_1_receive(buffer_el buffer[],  int buffer_size, 
