...
**
** Date of generation: 2015-08-30T19:51:19
** Command line:  $ uaadaptor.exe -n 'C:\Program Files (x86)\Esterel Technologies\Esterel SCADE 6.4.2\SCADE Display\config\Workspace\environments\UAPageCreator\A661Norm\a661.xml' -o 'ua' -outdir '..\UserApplication\KCG\' -k '..\UserApplication\KCG\kcg_trace.xml -d '..\DefinitionFile\project1.sgfx' ..\UserApplication\project1.sdy
**/
...
A661_INTERNAL int a661_com_layer_1(buffer_el msg[],  outC_project1* scade_ctx, 
 ...
 int ua_send(buffer_el msg[],  outC_project1* scade_ctx, 
  extern_out_ctx_t * extern_ctx){
  int n1 = 0;
...
int ua_receive(buffer_el buffer[],  int buffer_size,  inC_project1* scade_ctx, 
